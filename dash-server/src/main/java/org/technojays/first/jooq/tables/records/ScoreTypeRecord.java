...
import org.technojays.first.jooq.tables.interfaces.IScoreType;
...
public class ScoreTypeRecord extends UpdatableRecordImpl<ScoreTypeRecord> implements Record2<Integer, Object>, IScoreType {

	private static final long serialVersionUID = -389102741;
	 ...
	 */
	@Override
	public void from(IScoreType from) {
		setId(from.getId());
	 ...
	 */
	@Override
	public <E extends IScoreType> E into(E into) {
		into.from(this);
		return into;
	}
